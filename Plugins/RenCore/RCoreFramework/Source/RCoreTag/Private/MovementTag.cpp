...
UE_DEFINE_GAMEPLAY_TAG(TAG_Ability_Uses_Movement_Sprint, "Ability.Uses.Movement.Sprint");
UE_DEFINE_GAMEPLAY_TAG(TAG_Ability_Uses_Movement_Jump, "Ability.Uses.Movement.Jump");
UE_DEFINE_GAMEPLAY_TAG(TAG_Ability_Uses_Movement_Glide, "Ability.Uses.Movement.Glide");
