...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Uses_Movement_Sprint);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Uses_Movement_Jump);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Uses_Movement_Glide);
