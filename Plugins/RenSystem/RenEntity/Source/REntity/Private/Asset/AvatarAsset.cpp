...
const UAssetCollection* UAvatarAsset::GetExperienceAssets(const FAscensionData& Ascension) const
{
...
const UAssetCollection* UAvatarAsset::GetRankAssets(const FAscensionData& Ascension) const
{
